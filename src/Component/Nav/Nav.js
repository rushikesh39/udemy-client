...
function Nav() {
  ...
  return (
    <div className='ud-header'>
        ...
        <div className='categories' onMouseEnter={handleDropDown} onMouseLeave={handleDropDown}  ><p>Categories</p>
        {DropDown && (
      ...
      <input type='search' id='search' placeholder=' Search for anything'/>
        ...
        <div className='btn-grp'>
            ...
            <button className='btn-sing-in'><Link to={'/register'}>Sign up</Link></button>
