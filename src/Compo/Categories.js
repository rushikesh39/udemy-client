  ...
  return (
    <div>
      <div className="navsub">
        {displaySubnav ? (
          <>
            <NavLink className="textdeconone" to={`/category/${mainCategory}`}>
              <h5>{mainCategory}</h5>
            </NavLink>
            ...
            {mainCategorySubcats.map((item, index) => {
              return (
                <NavLink
                  ...
                  to={`/category/${item}`}
                >
                  <h5 key={index} className="h5normal">
                    {item}
                  </h5>
                </NavLink>
              );
          ...
          <>
            <NavLink className="textdeconone" to={`/category/${name}`}>
              <h5>{name}</h5>
            </NavLink>
            <div className="arrowimg">
              <img
      ...
      <div className="categorypage_maindiv">
        ...
        <h2 className="get-started">Courses to get you started</h2>
        ...
        <div className="poptopics_div">
          ...
          <div className="popmain_div">
            {poptopics.map((item, index) => {
              return (
                <p key={index} className="poptopics">
                  {item}
                </p>
              );
            })}
                      ...
                      {ishoveredtwo === index && (
                        <div className="arrow-containertwo">
                          ...
                          <div className="additional-content">
                            ...
                            <div className="buttondiv-addtocart">
                              <CartButton item={item} />
                              <div className="heartbutton_img">
                                <img
                                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSf9nKX4mmWawwlgehpJGHNxT5OcxKVlRsIzA&usqp=CAU"
